...
typedef enum{
    TCkWBRequestPostDataTypeNone,
	TCkWBRequestPostDataTypeNormal,		// for normal data post, such as "user=name&password=psd"
	TCkWBRequestPostDataTypeMultipart,    // for uploading images and files.
}TCWBRequestPostDataType;
...
@interface TCWBRequest : NSObject{
    ...
    NSString                *httpMethod;
    NSDictionary            *params;
    TCWBRequestPostDataType postDataType;
...
@property TCWBRequestPostDataType postDataType;
