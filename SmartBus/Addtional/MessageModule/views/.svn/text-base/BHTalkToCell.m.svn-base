...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        icon = [[UIImageView alloc]initWithFrame:CGRectMake(270.f, 5.f, 32.f, 32.f)];
        ...
        [bubble setImage:[[UIImage imageNamed:@"bg_chat02"] stretchableImageWithLeftCapWidth:15.f topCapHeight:18.f]];
...
- (void)setCellData:(BHMsgModel *)model hasTime:(BOOL)hasTime
{
    ...
    bubble.left = 260.f-bubble.width;
