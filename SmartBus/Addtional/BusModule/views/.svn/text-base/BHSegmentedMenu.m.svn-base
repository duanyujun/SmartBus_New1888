...
@implementation BHSegmentedMenu
...
- (void)drawRect:(CGRect)rect
{
    ...
    [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
        ...
        if (idx < self.sectionTitles.count - 1) {
            ...
            separatLine.frame = CGRectMake(self.segmentWidth * (idx + 1.f), 10.f, 10.f, 24.f);
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, self.layer.frame.size.height-self.selectionIndicatorHeight, stringWidth, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, self.layer.frame.size.height-self.selectionIndicatorHeight, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
